...
\cmditem{DeclareLabelwidthFieldCombination}{labelwidth name}{labelfield list}
\cmditem*{DeclareLabelwidthFieldCombination*}{labelwidth name}{labelfield list}

Declare a new length \len{\prm{labelwidth name}width} calculated on the basis of all fields given in the \prm{labelfield list}. That length can be used to set up combined lists of label fields.
The unstarred version appends the \prm{labelfield list} to the current list of fields, the starred version clears the list and replaces it.
...
\item Added \cmd{DeclareLabelwidthFieldCombination}\see{aut:fmt:ilc}
\end{release}
